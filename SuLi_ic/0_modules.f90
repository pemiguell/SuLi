...
real(8),parameter :: dt_frame = 10.


integer,parameter :: nx=int(.5/dx) , ny=int(1./dy), nz=int(0.8/dz)
!nz=int(10./dz1-0.1+0.5) porque a última célula é maior (0.5)
integer,parameter :: nx1=nx+1, ny1=ny+1, nz1=nz+1, ts = ceiling(2000./0.01)

!Para fazer dz variável no espaço inicialmente criar uma função ...
real(8),parameter :: uinicial = 3.

integer,parameter :: t_plot = 0 ! 0 = modo simples (velocidade, Level Set e IBM), 1 = modo completo (pressão, vorticidade, viscosidade)

integer,parameter :: t_tempo = 0 ! 0 = Euler Explícito, 1 = RK 2, 2 = RK 3, 3 = AB2
...
real(8), parameter :: tetah = 0.50, chezy = 44.5, decliv = 0.02
